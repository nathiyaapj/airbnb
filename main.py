...
st.set_page_config(page_title="Airbnb Data Visualization | By Karthik ",
...
with st.sidebar:
    selected = option_menu("Menu", ["Overview", "Explore","Contact"],
                           icons=["graph-up-arrow", "bar-chart-line","at"],
...
df = pd.read_csv('C:/Users/Admin/PycharmProjects/air.csv')
